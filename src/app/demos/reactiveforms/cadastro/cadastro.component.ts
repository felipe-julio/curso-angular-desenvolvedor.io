...
import { fromEvent, merge, Observable, VirtualTimeScheduler } from 'rxjs';
...
export class CadastroComponent implements OnInit, AfterViewInit {
  ...
  constructor(private fb: FormBuilder) {
    this.validationMessages = {
      nome: {
        ...
        rangeLength: 'O Nome precisa ter entre 2 a 150 caracteres'
      },
      email: {
  ...
  ngOnInit() {
    ...
    this.cadastroForm = this.fb.group({
      nome: ['', [Validators.required, CustomValidators.rangeLength([2, 150])]],
